...
.Event.java
----
include::../main/java/ac/simons/simplemeetup/domain/Event.java[tags=eventStructure]
----
...
----
include::../test/java/ac/simons/simplemeetup/domain/EventTest.java[tags=unitTestExamplePre,indent=0]

include::../test/java/ac/simons/simplemeetup/domain/EventTest.java[tags=unitTestExamplePost,indent=0]
----
...
----
include::../main/java/ac/simons/simplemeetup/domain/EventRepository.java[tags=eventRepositoryStructure,indent=0]
----
...
----
include::../main/java/ac/simons/simplemeetup/domain/EventService.java[tags=eventServiceSaveEvents,indent=0]
----
...
.Test des Service
----
include::../test/java/ac/simons/simplemeetup/domain/EventServiceTest.java[tags=eventServiceSaveEvents,indent=0]
----
...
.Events API
----
include::../main/java/ac/simons/simplemeetup/app/EventsApi.java[tags=eventApiEvent,indent=0]
----
...
.Test der API
----
include::../test/java/ac/simons/simplemeetup/app/EventsApiTest.java[tags=eventApiEvent,indent=0]
----
...
.Events API
----
include::../main/java/ac/simons/simplemeetup/domain/EventRepository.java[tags=eventRepositoryITNeeded,indent=0]
----
...
Integrationstests gegen Datenbanken können heikel sein. Schwergewichtige Datenbanken wie eine Oracle-Datenbank nur für einen Tests zu starten, kann dauern. Gegen In-Memory-Datenbanken zu testen bildet nicht die Realität ab. Eine Alternative ist die Generierung unterschiedlicher Schemas für Tests zwecke. Das Beispielprojekt des Artikels geht den konsequenten Weg und startet die Zieldatenbank, eine PostgreSQL-Instanz, während der Integrationstests per https://www.docker.com[Docker]. Die Datenbank wird mit den Mitteln von Spring-Boot initialisiert und der vollständige Test ergibt sich in <<EventRepositoryIT>>.

[source,java]
[[EventRepositoryIT]]
.Integrationstests gegenüber einer Datenbank
----
include::../integrationTest/java/ac/simons/simplemeetup/domain/EventRepositoryIT.java[tags=eventRepositoryIT,indent=0]
----
...
Die Veränderung der Testabdeckung, insbesondere nach unten, kann dennoch eine Metrik zur Steuerung eines Projektes sein. Ein bekanntes Tool in der Java-Welt ist http://www.eclemma.org/jacoco/[JaCoCo]. <<GradleJaCoCo>> zeigt, dass JaCoCo mit nur wenigen Zeilen in Ihr Gradle-Build-File eingebaut werden kann. Es wird überprüft, ob mindest 60% aller Statements abedeckt sind.

[source,groovy]
[[GradleJaCoCo]]
.Überprüfung der Testabdeckung mit JaCoCo
----
include::../../build.gradle[tags=jacoco]
----
